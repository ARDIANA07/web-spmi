    ...
    <div class="col-md-10 offset-md-1">
        <form action="/product" method="POST" enctype='multipart/form-data'>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="name" class="form-control" placeholder="Product Name" aria-label="Product Name"
                    aria-describedby="productName" required="true">
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text" id="productPrice"><i class="bi bi-cash"></i></span>
                <input type="number" name="price" class="form-control" placeholder="Product Price"
                    aria-label="Product Price" aria-describedby="productPrice" required="true">
            </div>
            <div class="input-group mb-3">
                ...
                <input type="number" name="stock" class="form-control" placeholder="Product Stock"
                    aria-label="Product Stock" aria-describedby="productStock" required="true">
            </div>
